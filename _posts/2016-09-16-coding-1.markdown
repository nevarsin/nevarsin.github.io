---
layout: post
title:  "Your old Raspberry PI as a home router"
description: Every geek has at least one unused Raspberry Pi laying around, this is a tutorial to set it up as your own home router. 
